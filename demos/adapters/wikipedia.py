"""CLI-Judge adapter for the Printing-Press `wikipedia` CLI (proof target).
...
DEFAULT_BINARY = "wikipedia"
_BASE_URL_ENVS = ["API_BASE_URL", "BASE_URL", "PP_BASE_URL", "WIKIPEDIA_BASE_URL"]
...
ADAPTER: Adapter = WikipediaAdapter()
